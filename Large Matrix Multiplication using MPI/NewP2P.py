...
# Formation of matrix A and B
A=np.arange(0,10000,0.01).reshape((1000,1000))
B=np.transpose(A)

# Calculation of dot product of matrix A and B without using MPI
...
if rank == 0:
   ...
   print "Dot product of matrix A and B without using MPI is:"
   print D
   print "Dot product of matrix A and B using MPI is:"
   print C
   Cdetm = np.linalg.det(C)
   Ddetm = np.linalg.det(D)
   print "Determinant of dot product of matrix A and B without using MPI is: ", Ddetm
   print "Determinant of dot product of matrix A and B using MPI is: ", Cdetm
   assert C.all()==D.all()
